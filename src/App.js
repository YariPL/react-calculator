    ...
    return(
      <div className="Buttons">
        <div className='row'>
          ...
          <div className='by' data-id='/' onClick={(event)=>this.handleClick(event.currentTarget.getAttribute('data-id'))}>
            <span>/</span>
          </div>
          <div className='times' data-id='*' onClick={(event)=>this.handleClick(event.currentTarget.getAttribute('data-id'))}>
            <span>X</span>
          </div>
        </div>
        <div className='row'>
          ...
          <div className='minus' data-id='-' onClick={(event)=>this.handleClick(event.currentTarget.getAttribute('data-id'))}>
            <span>-</span>
          </div>
        </div>
        <div className='row'>
          ...
          <div className='plus' data-id='+' onClick={(event)=>this.handleClick(event.currentTarget.getAttribute('data-id'))}>
            <span>+</span>
          </div>
        </div>
